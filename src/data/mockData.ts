...
export const MOCK_EQUIPMENT: Equipment[] = [
  ...
  },
  {
    ...
    lat: 30.2500,
    lng: -97.7000,
    coordinates: { lat: 30.2500, lng: -97.7000 },
    dailyRate: 180,
    weeklyRate: 850,
    securityDeposit: 400,
    rating: 4.9,
...
export const MOCK_BOOKINGS: Booking[] = [
  {
    ...
    deliveryAddress: '742 Industrial Pkwy, Austin TX',
    status: 'confirmed',
    priceBreakdown: {
      dailyRate: 285,
      rentalDays: 3,
...
export const MOCK_REVIEWS: Review[] = [
  {
    ...
    fromRole: 'customer',
    rating: 5,
    comment: 'The excavator was delivered promptly to our job site in Austin. Performed excellently for trenching and foundation work.',
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    message: 'Marcus Vance confirmed your reservation for Aug 15 to Aug 18.',
