...
import { Sparkles, DollarSign, CheckCircle2, RefreshCw, X } from "lucide-react";
import axios from "axios";
export const AiPricingAssistantModal = ({
  equipment,
  isOpen,
  onClose,
  onApplyNewPrice
  ...
  >
    ...
    /* Header */
        ...
        {loading ? <div className="py-12 text-center space-y-3">
            <div className="w-10 h-10 border-4 border-purple-600 border-t-transparent rounded-full animate-spin mx-auto" />
            <p className="text-xs font-semibold text-slate-600">
              Analyzing regional demand pipeline for {equipment.title}...
            </p>
          </div> : suggestion ? <div className="space-y-5">
            {
    ...
    /* AI Insights Bullets */
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-slate-600">
                {suggestion.reasoning.map((r, i) => <li key={i} className="flex items-start gap-2 bg-slate-50 p-2.5 rounded-xl border border-slate-100">
