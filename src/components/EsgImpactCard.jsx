...
export const EsgImpactCard = ({ co2SavedKg, title = "Circular Fleet ESG Impact" }) => {
  return <div className="p-5 rounded-2xl bg-[#111111] border border-[#1F1F1F] text-white shadow-xl space-y-3">
