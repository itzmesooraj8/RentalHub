...
export const EmptyState = ({
  ...
  return <div className="bg-[#111111] rounded-3xl p-12 text-center border border-[#1F1F1F] max-w-md mx-auto space-y-4 font-sans">
  ...
  >
      ...
      {actionLabel && !actionPath && onAction && <button
    onClick={onAction}
