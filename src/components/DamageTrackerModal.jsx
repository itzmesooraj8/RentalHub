...
import { Camera, AlertTriangle, CheckCircle, Upload, X } from "lucide-react";
import axios from "axios";
export const DamageTrackerModal = ({
  booking,
  isOpen,
  onClose,
  onUpdated
  ...
  const [returnPhotos, setReturnPhotos] = useState(
    booking.condition.returnPhotos?.length ? booking.condition.returnPhotos : ["https://images.unsplash.com/photo-1504148455328-c376907d081c?auto=format&fit=crop&q=80&w=1000"]
  );
  ...
  /> : <div className="w-full h-36 rounded-xl border-2 border-dashed border-slate-300 flex flex-col items-center justify-center text-slate-400 text-xs mb-2">
            ...
            <div className="flex items-center gap-1">
              ...
              {samplePhotoOptions.map((url, i) => <button
    key={i}
    type="button"
