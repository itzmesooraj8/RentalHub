...
export class AppErrorBoundary extends React.Component<AppErrorBoundaryProps, AppErrorBoundaryState> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#0A0A0A] text-slate-100 flex items-center justify-center p-6 font-sans">
          <div className="max-w-md w-full bg-[#111111] border border-[#222222] rounded-3xl p-8 text-center space-y-6 shadow-2xl">
            ...
            {this.state.error && (
              <div className="p-3 bg-[#181818] border border-[#282828] rounded-xl text-[11px] font-mono text-rose-300 text-left overflow-x-auto max-h-32">
