...
import { ShieldCheck, Star, Clock, CheckCircle2, Award, X, Sparkles, ChevronRight } from 'lucide-react';
...
export const TrustScoreBadge: React.FC<TrustScoreBadgeProps> = ({
  ...
  // 60% based on Review Rating, 30% based on On-Time Rental Record, 10% based on KYC Verification
  ...
  return (
    <>
      ...
      >
        ...
        {kycVerified && (
          <span className="ml-1 pl-1.5 border-l border-[#333333] text-[#888888] font-mono text-[9px]">
            KYC OK
          </span>
        )}
      </button>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 font-mono text-white">
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A] space-y-1.5">
                ...
                <div className="w-full bg-[#111111] h-1.5 rounded-full overflow-hidden">
                  <div className="bg-amber-400 h-full" style={{ width: `${(rating / 5) * 100}%` }}></div>
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A] space-y-1.5">
                ...
                <div className="w-full bg-[#111111] h-1.5 rounded-full overflow-hidden">
                  <div className="bg-emerald-400 h-full" style={{ width: `${onTimeRatio * 100}%` }}></div>
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A] space-y-1.5">
                ...
                <div className="w-full bg-[#111111] h-1.5 rounded-full overflow-hidden">
                  <div className="bg-[#F27D26] h-full" style={{ width: kycVerified ? '100%' : '0%' }}></div>
                </div>
              </div>
            </div>
