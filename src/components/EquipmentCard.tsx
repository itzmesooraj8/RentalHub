...
export const EquipmentCard: React.FC<EquipmentCardProps> = ({
  ...
  return (
    <div className="group bg-[#111111] rounded-3xl border border-[#1F1F1F] hover:border-[#333333] transition-all duration-200 overflow-hidden shadow-xl flex flex-col justify-between">
          ...
          <button
            ...
            className={`absolute top-3 right-3 p-2 rounded-full backdrop-blur-md transition cursor-pointer ${
              isFavorite
                ...
                : 'bg-[#0A0A0A]/70 text-white hover:bg-[#0A0A0A]'
            }`}
