...
export const AdminCategoriesPage = () => {
  ...
  const handleAddCategory = async (e) => {
    ...
    if (!newName) return;
    try {
      const res = await apiClient.post("/api/admin/categories", {
        name: newName,
        icon: newIcon,
        description: newDesc,
  ...
  >
    ...
    /* Categories Grid */
      ...
      {loading ? <div className="text-center py-16 bg-[#111111] border border-[#222222] rounded-3xl">
          ...
          {categories.map((cat) => <div key={cat.id} className="bg-[#111111] border border-[#222222] rounded-3xl p-6 space-y-4 relative flex flex-col justify-between">
