...
export const OwnerEquipmentFormPage = ({
  ...
  const [weeklyRate, setWeeklyRate] = useState(1400);
  const [securityDeposit, setSecurityDeposit] = useState(800);
  ...
  return <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 font-mono text-white">
      {
    /* Top Bar */
  }
  ...
  />
    ...
    /* Section 3: Dynamic Category Specifications */
          ...
          <div className="p-5 bg-[#1A1A1A] rounded-2xl border border-[#222222] space-y-4">
            ...
            {category === "Photography & Drones" ? <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
  ...
  />
              ...
              </div> : category === "Heavy Machinery" ? <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
  ...
  />
              ...
              </div> : category === "Generators" ? <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
  ...
  />
              ...
              {coverImage && <div className="w-32 h-20 rounded-xl overflow-hidden border border-[#333]">
