        ...
        <div className="flex items-center gap-2 font-mono text-xs">
          <button
            ...
            className={`px-4 py-2 rounded-xl transition ${
              activeTab === 'all' ? 'bg-[#F27D26] text-black font-bold' : 'bg-[#1A1A1A] text-slate-300 hover:bg-[#252525]'
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl transition ${
              activeTab === 'pending' ? 'bg-[#F27D26] text-black font-bold' : 'bg-[#1A1A1A] text-slate-300 hover:bg-[#252525]'
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl transition ${
              activeTab === 'active' ? 'bg-[#F27D26] text-black font-bold' : 'bg-[#1A1A1A] text-slate-300 hover:bg-[#252525]'
            }`}
          >
            ...
            <table className="w-full text-left font-mono text-xs">
              ...
              <tbody className="divide-y divide-[#1F1F1F]">
                {filteredEquipment.map((item) => (
                  <tr key={item.id} className="hover:bg-[#161616] transition">
                    <td className="p-4">
