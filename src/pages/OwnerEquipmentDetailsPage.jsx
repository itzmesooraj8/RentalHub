...
export const OwnerEquipmentDetailsPage = ({
  ...
  return <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 font-mono text-white">
      {
    /* Top Bar */
  }
  ...
  >
    ...
    /* Specifications */
          ...
          <div className="bg-[#111111] rounded-3xl p-6 border border-[#1F1F1F] shadow-xl space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
              {Object.entries(equipment.specs || {}).map(([key, val]) => <div key={key} className="p-3 bg-[#1A1A1A] rounded-2xl border border-[#222222]">
    ...
    /* Asset Reviews History */
          ...
          <div className="bg-[#111111] rounded-3xl p-6 border border-[#1F1F1F] shadow-xl space-y-4">
            ...
            {assetReviews.length === 0 ? <p className="text-xs text-[#888888] italic">No reviews submitted for this specific asset yet.</p> : <div className="space-y-3">
                {assetReviews.map((r) => <div key={r.id} className="p-3.5 bg-[#1A1A1A] rounded-2xl border border-[#222222] space-y-1 text-xs">
