...
import { Equipment, Booking, User, AnalyticsData } from '../types';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 font-mono text-white">
      ...
      <div className="bg-[#111111] rounded-3xl p-6 border border-[#1F1F1F] shadow-xl space-y-4 font-mono text-xs">
        ...
        {incomingBookings.length === 0 ? (
          <p className="text-xs text-[#888888] italic">No pending booking requests.</p>
        ) : (
          <div className="space-y-3">
            {incomingBookings.slice(0, 3).map((b) => (
              <div key={b.id} className="p-3.5 rounded-2xl bg-[#1A1A1A] border border-[#262626] flex items-center justify-between">
                <div>
