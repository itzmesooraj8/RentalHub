    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 font-mono text-white">
      ...
      <div className="bg-[#111111] rounded-3xl p-6 sm:p-8 border border-[#1F1F1F] shadow-2xl space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="p-4 rounded-2xl bg-[#1A1A1A] border border-[#222222]">
            <span className="text-[10px] font-bold uppercase tracking-wider text-[#666666]">Processed GMV Volume</span>
            <div className="text-2xl font-serif italic font-bold text-[#F27D26] mt-1">${totalVolume}</div>
          </div>

          <div className="p-4 rounded-2xl bg-[#1A1A1A] border border-[#222222]">
            <span className="text-[10px] font-bold uppercase tracking-wider text-[#666666]">Total Active Bookings</span>
            <div className="text-2xl font-serif italic font-bold text-white mt-1">{bookings.length}</div>
          </div>

          <div className="p-4 rounded-2xl bg-[#1A1A1A] border border-[#222222]">
            <span className="text-[10px] font-bold uppercase tracking-wider text-[#666666]">Open Claims / Disputes</span>
            <div className="text-2xl font-serif italic font-bold text-rose-400 mt-1">{openDisputes.length}</div>
          </div>

          <div className="p-4 rounded-2xl bg-[#1A1A1A] border border-[#222222]">
            <span className="text-[10px] font-bold uppercase tracking-wider text-[#666666]">Pending Moderations</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 font-mono text-xs">
        ...
        >
          ...
          <div className="text-[#F27D26] font-bold uppercase text-[10px] flex items-center gap-1">
