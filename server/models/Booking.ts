...
import { Booking as BookingType } from '../../src/types';
...
export const BookingModel: Model<BookingType> =
  (mongoose.models.Booking as Model<BookingType>) || mongoose.model<BookingType>('Booking', BookingSchema);
